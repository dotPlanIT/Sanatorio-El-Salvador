...
<?PHP 
	...
	$db = new MySQL();
	$consulta = $db->consulta("SELECT * FROM institutionals where id=18");
	$error404 = false;
	...
	<div class="cuerpo">
		...
		<?php if($error404 == false){ ?>
			<div class="breadcrumb">
				...
				<a href="./chequeos-corporativos.php">Servicios :: Chequeos M&eacute;dicos :: Corporativos</a>
			</div>
			<div id="contenedor">
				<div class="pageTitle">Chequeo Corporativo</div>
