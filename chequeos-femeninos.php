...
<?PHP 
	...
	$db = new MySQL();
	$consulta = $db->consulta("SELECT * FROM institutionals where id=26");
	$error404 = false;
	...
	<div class="cuerpo">
		...
		<?php if($error404 == false){ ?>
			<div class="breadcrumb">
				...
				<a href="./quienes-somos.php">Servicios :: Chequeos M&eacute;dicos :: Femeninos</a>
			</div>
			<div id="contenedor">
				<div class="pageTitle">Chequeos Femeninos</div>
