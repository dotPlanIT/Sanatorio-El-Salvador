...
<?PHP 
	...
	$db = new MySQL();
	$consulta = $db->consulta("SELECT * FROM institutionals where id=11");
	$error404 = false;
	...
	<div class="cuerpo">
		...
		<?php if($error404 == false){ ?>
			<div class="breadcrumb">
				...
				<a href="./comites.php">Quienes Somos :: Comit&eacute;s</a>
			</div>
			<div id="contenedor">
				<div class="pageTitle">Comit&eacute;s</span></div>
