...
<?PHP 
	...
	$db = new MySQL();
	$consulta = $db->consulta("SELECT * FROM institutionals where id=27");
	$error404 = false;
	...
	<div class="cuerpo">
		...
		<?php if($error404 == false){ ?>
			<div class="breadcrumb">
				...
				<a href="./quienes-somos.php">Servicios :: Chequeos M&eacute;dicos :: Masculinos</a>
			</div>
			<div id="contenedor">
				<div class="pageTitle">Chequeos Masculinos</div>
