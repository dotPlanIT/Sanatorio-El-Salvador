...
<?PHP 
	...
	$db = new MySQL();
	$consulta = $db->consulta("SELECT * FROM institutionals where id=23");
	$error404 = false;
	...
	<div class="cuerpo">
		...
		<?php if($error404 == false){ ?>
			<div class="breadcrumb">
				...
				<a href="./comite-capacitacion-docencia.php">Docencia e Investigaci&oacute;n  :: Comit&eacute; Capacitaci&oacute;n y Docencia</a>
			</div>
			<div id="contenedor">
				<div class="pageTitle">Comit&eacute; Capacitaci&oacute;n y Docencia</div>
