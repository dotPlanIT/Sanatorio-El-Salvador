...
<?PHP 
	...
	$db = new MySQL();
	$consulta = $db->consulta("SELECT * FROM institutionals where id=25");
	$error404 = false;
	...
	<div class="cuerpo">
		...
		<?php if($error404 == false){ ?>
			<div class="breadcrumb">
				...
				<a href="./residencias-medicas.php">Docencia e Investigaci&oacute;n  :: Residencias M&eacute;dicas</a>
			</div>
			<div id="contenedor">
				<div class="pageTitle">Residencias M&eacute;dicas</div>
