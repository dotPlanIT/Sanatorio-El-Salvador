...
<?PHP 
	...
	$db = new MySQL();
	$consulta = $db->consulta("SELECT * FROM institutionals where id=16");
	$error404 = false;
	...
	<div class="cuerpo">
		...
		<?php if($error404 == false){ ?>
			<div class="breadcrumb">
				...
				<a href="./chequeos-infanto-juvenil.php">Servicios :: Chequeos M&eacute;dicos :: Infanto-Juvenil</a>
			</div>
			<div id="contenedor">
				<div class="pageTitle">Chequeo Infanto-Juvenil</div>
