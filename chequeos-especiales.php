...
<?PHP 
	...
	$db = new MySQL();
	$consulta = $db->consulta("SELECT * FROM institutionals where id=19");
	$error404 = false;
	...
	<div class="cuerpo">
		...
		<?php if($error404 == false){ ?>
			<div class="breadcrumb">
				...
				<a href="./chequeos-especialies.php">Servicios :: Chequeos M&eacute;dicos:: Especiales</a>
			</div>
			<div id="contenedor">
				<div class="pageTitle">Chequeos Especiales</div>
