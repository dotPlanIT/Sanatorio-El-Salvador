...
<?PHP 
	...
	$db = new MySQL();
	$consulta = $db->consulta("SELECT * FROM institutionals where id=24");
	$error404 = false;
	...
	<div class="cuerpo">
		...
		<?php if($error404 == false){ ?>
			<div class="breadcrumb">
				...
				<a href="./fundacion-pro-medica.php">Fundación Pro M&eacute;dica </a>
			</div>
			<div id="contenedor">
				<div class="pageTitle">Fundación Pro M&eacute;dica </div>
