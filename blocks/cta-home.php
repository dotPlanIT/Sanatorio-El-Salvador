...
if($db->num_rows($consulta)>0){
	...
	<a href="<?PHP echo $cta['link'];?>">
		<div class="homeCallToAction">
			<img src="http://localhost/cms/app/webroot/files/buttons/<?PHP echo $cta['image_dir'];?>/button_<?PHP echo $cta['image'];?>" onerror="this.onerror=null;this.src='./img/default/icon-S.png';" /></br>
