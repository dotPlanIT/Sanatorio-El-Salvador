...
<div id="form-wrap"> 
<form> 
<div id="form-inner"> <label for="name"> Nombre : </ label> <input type = clase "text" = id "entrada" = "nombre" marcador de posición = " Introduzca su nombre aquí "> 
<label for="email"> Email : </ label><input type = class "email" = id "entrada" = marcador de posición "email" = "Introduzca una válida Email "> <label for="message"> mensaje : </ label><textarea class = "textarea entrada" id = "" marcador de posición = "MensajeEscriba aquí su mensaje "> </ textarea> <br /> < input type = class "reset" = valor "botón" = "Restaurar"> 
