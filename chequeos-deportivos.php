...
<?PHP 
	...
	$db = new MySQL();
	$consulta = $db->consulta("SELECT * FROM institutionals where id=17");
	$error404 = false;
	...
	<div class="cuerpo">
		...
		<?php if($error404 == false){ ?>
			<div class="breadcrumb">
				...
				<a href="./chequeos-deportivos.php">Servicios :: Chequeos M&eacute;dicos :: Deportivo</a>
			</div>
			<div id="contenedor">
				<div class="pageTitle">Chequeo Deportivo</div>
