...
<?PHP 
	...
	$db = new MySQL();
	$consulta = $db->consulta("SELECT * FROM institutionals where id=28");
	$error404 = false;
	...
	<div class="cuerpo">
		...
		<?php if($error404 == false){ ?>
			<div class="breadcrumb">
				...
				<a href="./medicina-laboral.php">Servicios :: Medicina Laboral</a>
			</div>
			<div id="contenedor">
				<div class="pageTitle">Medicina Laboral</div>
